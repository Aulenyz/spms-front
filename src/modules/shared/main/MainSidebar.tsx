...
export const MainSidebar = () => {
    ...
    return (
        <aside
            className={clsx(
                "fixed top-0 left-0 h-screen z-[9999] bg-white text-gray-800 flex flex-col justify-between shadow-lg border-r border-gray-200 transition-all duration-300 ease-in-out",
