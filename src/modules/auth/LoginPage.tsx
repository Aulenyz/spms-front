                ...
                <div
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center space-y-6">
                        ...
                        <h2 className="text-4xl font-bold leading-tight drop-shadow-md">
                            Bienvenido a tu portal escolar
                        </h2>
                        <p className="text-lg font-medium leading-relaxed text-blue-100 max-w-md">
                            Una plataforma moderna diseñada para facilitar la administración académica,
                            los pagos, descuentos y el seguimiento de notas. Simplifica tu gestión y
                            mantente al día con todo lo importante.
                        </p>
                    </div>
                </div>
